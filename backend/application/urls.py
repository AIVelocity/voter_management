...
urlpatterns = [
    ...
    # path("voters/voters-csv-report/",views.voters_export_csv,name="voters_export_csv"),
    ...
    path("mobile/print/list/",views.list_voters_for_print,name="list_voters_for_print"),
