...
- [ ] [Create](https://docs.github.com/ee/user/project/repository/web_editor.html#create-a-file) or [upload](https://docs.gitlab.com/ee/user/project/repository/web_editor.html#upload-a-file) files
...
```
cd existing_repo
git remote add origin https://github.com/AIVelocity/voter_management.git
git branch -M voter_management_system
git push -uf origin voter_management_system
```

## Integrate with your tools

- [ ] [Set up project integrations](https://github.com/AIVelocity/voter_management.git/-/settings/integrations)
